...
/// @nodoc
abstract class $TokenCardDbCopyWith<$Res> {
  factory $TokenCardDbCopyWith(
          TokenCardDb value, $Res Function(TokenCardDb) then) =
      _$TokenCardDbCopyWithImpl<$Res, TokenCardDb>;
  @useResult
  $Res call(
      {String id,
      int? power,
...
/// @nodoc
class _$TokenCardDbCopyWithImpl<$Res, $Val extends TokenCardDb>
    implements $TokenCardDbCopyWith<$Res> {
  _$TokenCardDbCopyWithImpl(this._value, this._then);
...
class _$TokenCardDbImpl extends _TokenCardDb {
  _$TokenCardDbImpl(
      {required this.id,
      required this.power,
  ...
  _$$TokenCardDbImplCopyWith<_$TokenCardDbImpl> get copyWith =>
      __$$TokenCardDbImplCopyWithImpl<_$TokenCardDbImpl>(this, _$identity);
}

abstract class _TokenCardDb extends TokenCardDb {
  factory _TokenCardDb(
